...
RUN curl -L -o erdas-ecw-sdk-5.5.0-linux.zip http://go.hexagongeospatial.com/erdas-ecw-jp2-sdk-v5-5-linux \
    && unzip erdas-ecw-sdk-5.5.0-linux.zip \
    ...
    && rm ECWJP2SDKSetup_5.5.0.1501.bin \
